...
const COLUMN_ANIMATIONS: DotAnimationVariant[] = [
  { delay: 0, duration: 4.4, keyTimes: '0;0.35;0.65;1', values: '1;0.2;0.6;1' },
  { delay: 1.1, duration: 5.1, keyTimes: '0;0.25;0.5;0.75;1', values: '1;0.45;0.15;0.6;1' },
  { delay: 0.6, duration: 3.8, keyTimes: '0;0.4;0.7;1', values: '1;0.3;0.75;1' },
  { delay: 1.7, duration: 4.9, keyTimes: '0;0.2;0.5;0.8;1', values: '1;0.35;0.1;0.55;1' },
  { delay: 0.9, duration: 5.6, keyTimes: '0;0.3;0.6;1', values: '1;0.25;0.65;1' },
  { delay: 1.3, duration: 6.2, keyTimes: '0;0.2;0.45;0.7;1', values: '1;0.15;0.55;0.3;1' },
];

function DottedLine() {
  const gradientId = useId();
  const containerRef = useRef<HTMLDivElement>(null);
  const [dimensions, setDimensions] = useState({ width: VIEWBOX_WIDTH, height: VIEWBOX_HEIGHT });
