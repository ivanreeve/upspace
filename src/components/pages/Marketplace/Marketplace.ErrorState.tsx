  ...
  return (
    <div className={ cn('w-full', className) } aria-hidden="true">
      <svg
        ...
        className="h-full w-full"
      >
        <circle cx="200" cy="150" r="120" fill="#F2F2F2" />

        <g className="error-robot-body-light">
          <ellipse cx="200" cy="240" rx="40" ry="6" fill="#D9CFC7" opacity="0.4" />

          <rect x="150" y="140" width="100" height="80" rx="20" fill="#DFD7BF" />
          <rect x="150" y="140" width="100" height="76" rx="20" fill="#DFD7BF" />

          <rect x="170" y="160" width="60" height="40" rx="4" fill="#FDFBF7" />
          <path
            d="M175 180 H190 L195 170 L205 190 L210 180 H225"
            stroke="#5C7C8A"
            strokeWidth="2"
          ...
          <rect x="190" y="130" width="20" height="10" fill="#DFD7BF" />

          <rect x="140" y="60" width="120" height="70" rx="16" fill="#DFD7BF" />
          <rect x="140" y="60" width="120" height="66" rx="16" fill="#DFD7BF" />

          <rect x="155" y="75" width="90" height="40" rx="4" fill="#FDFBF7" />
          ...
          <path d="M200 60 V 40" stroke="#DFD7BF" strokeWidth="4" />
          <circle cx="200" cy="35" r="5" fill="#8CB9BD" />
      ...
      <style>{ `
        ...
        .error-robot-body-light { animation: error-float 4s ease-in-out infinite; }
      ` }</style>
    </div>
  );
}
